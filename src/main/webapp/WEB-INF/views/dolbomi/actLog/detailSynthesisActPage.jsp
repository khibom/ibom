...
<main id="main" class="main_container">
	...
	<form action="${pageContext.request.contextPath}/dolbomi/insynAct.do" onsubmit="fromDataCheck()" method="post" >				
    ...
    <h3 style=" color:rgb(243, 114, 51); width:49%; margin-top:30px;">활동내역</h3><br/>
   <p style=" color:rgb(243, 114, 51); font-size:9pt;">
  ...
  <div class="jt_board_list_wrap">
		<table class="jt_board_list" id="synLog">
            <thead>
                <tr>
                	<th scope="col" class="type" style="width:5%;">
                	<label>
