...
<main id="main" class="main_container">
	...
	<ul style=" display:inline-block; postion:relative; width:100%;">
		<li style="float:left; width:49%; margin-left:5px; color:rgb(243, 114, 51);"><h4>종일제 활동일지</h4></li>
	</ul>				
    ...
    <table class="jt_board_list">
       ...
       <tr>
			...
			<td><textarea style="border:none; height:100px;resize: none;" readonly>${allday.cond_content}</textarea></td>
	  </tr>
	 </tbody>
	</table>
          ...
          <!--  list 처리 -->
          <ul style=" display:inline-block; postion:relative; width:100%;">
			<li style="float:left; width:49%; margin-left:5px; color:rgb(243, 114, 51);"><h4>투약의뢰</h4></li>
		 </ul>
          <div class="jt_board_list_wrap">
		<table class="jt_board_list">
            <thead>
           ...
           <tbody>
                          		<tr>
									...
									<c:forEach var="i" items="${dosageTime }">
										<td class="nopadding">
										<input type="text" name="dosage_time"style="width:25%;" value="${i}">
										</td>
									</c:forEach>
								</tr>
								<tr>
									...
									<c:forEach var="i" items="${dosage }">
										<td class="nopadding">
										<input type="text" name="dosage"style="width:25%;" value="${i}">
										</td>
									</c:forEach>
								</tr>
								<tr>
									<th>증상</th>
									<td colspan="4"><textarea name="symotom" rows="4" style="border:none;">${allday.symotom}</textarea></td>
								</tr>
								<tr>
									<th>복용방법</th>
									<td colspan="4"><textarea name="dos_method" rows="4" style="border:none;">${allday.dos_method}</textarea></td>
								</tr>
								<tr>
									<th>보관상태</th>
									<td colspan="4"><textarea name="stg_condition" rows="4" style=" border:none;">${allday.stg_condition }</textarea></td>
								</tr>
								<tr>
									<th>특이사항</th>
          		...
          		<div style="width:100%; height:100px; position:relative;"></div>
          <ul style=" display:inline-block; postion:relative; width:100%;">
			<li style="float:left; width:49%; margin-left:5px; color:rgb(243, 114, 51);"><h4>영아상태</h4></li>
		 </ul>
          		<div class="jt_board_list_wrap">
		<table class="jt_board_list">
            <tbody>
				<tr>
					...
					<c:forTokens  var="i" items="${allday.bodytemp_time }" delims=",">
							<td class="nopadding">
								<input type="text" name="bodytemp_time"style="width:25%;" value="${i}" required>
						   </td>
							</c:forTokens>
					</tr>
					<tr>
            ...
            <tbody>
        		...
        		<div style="width:100%; height:100px; position:relative;"></div>
          <ul style=" display:inline-block; postion:relative; width:100%;">
			<li style="float:left; width:49%; margin-left:5px; color:rgb(243, 114, 51);"><h4>실내환경</h4></li>
		 </ul>
          		<div class="jt_board_list_wrap">
		<table class="jt_board_list">
            <tbody>
			                ...
			                <tr>
			                    ...
			                    <td><input type="text" name="ven_time" value="${i}" style="width:25%;"></td>
			                    </c:forTokens>
			                </tr>
							<tr>
							  <th>온도</th>
							  <c:forTokens  var="i" items="${allday.ven_temp}" delims=",">
			                  <td><input type="text" name="ven_temp" value="${i}" style="width:20%;">℃</td>
			                  </c:forTokens>
			                </tr>
			                <tr>
							  <th>습도</th>
        ...
        <div class="submit">
      	<input type="submit"value="제출"style="float:right; margin-top:10px;" class="btn waves-effect orange darken-3" >
      	</div>
      	<div class="list">	
