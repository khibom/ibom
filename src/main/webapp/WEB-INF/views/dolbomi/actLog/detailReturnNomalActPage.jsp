...
<main id="main" class="main_container">
	...
	<tr>
        ...
        <h5 style=" color:rgb(243, 114, 51); width:49%; margin-top:30px;">반려사유</h5><br/>
    <table class="jt_board_list">
            <caption>게시판 목록</caption>
        <tbody>
       <tr>
			<th scope="col" class="type">반려사유</th>
			<td><textarea style="border:none; height:100px;resize: none;" readonly>${nomal.cond_cnt}</textarea></td>
	  </tr>
	 </tbody>
	</table>
       <div class="submit">
