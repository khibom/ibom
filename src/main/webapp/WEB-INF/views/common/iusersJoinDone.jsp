			...
			<div class="row">        			
           		<div class="btn_area double" align="center" style="margin-top:10px;">
					<span>
						...
						<a href="#" id="btnCancel4"	class="waves-effect waves-light btn grey" role="button" style="width:15%;">홈</a>
					</span> 
					<span>
						<!-- tg-text=terms_button_agree -->
						<a href="#" id="nextBtn4" class="waves-effect waves-light btn orange darken-3" role="button" style="width:15%;">로그인</a>
					</span>
				</div>
			  </div><!--  row -->
	 <!-- ========================================================================================================= -->
