...
:root {
  ...
  --animation-sentence: '네가\'떠나기로 한거, 알지?';
...
@keyframes showText {
  ...
  100% {
    --animation-sentence: '할 일이 너무 많고, 시간은 너무 적어서...';
  }
}
@keyframes showNewText {
  ...
  100% {
    --animation-sentence: '좋아, 넌 이 일에 관심이 있는 것 같아.';
  }
}
...
<div class="container">
  ...
  <p><a href="${pageContext.servletContext.contextPath }/main.do" class="home_s" style="color:#fff; font-size:18px;">홈으로</a> </p>
  <svg class="keyhole">
    <use href="#keyhole"/>
  </svg>
</div>
