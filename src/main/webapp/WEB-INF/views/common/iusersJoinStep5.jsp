...
$("#btnCancel5").click(function(event) {
...
/* function print(printArea)
{
		...
		*/
		...
		win.document.write('<header><main>');
		win.document.write(printArea);
		win.document.write('</main></header>');
		...
		<div class="article_body">
			...
			<div id="printArea"><!--  프린트 영역 -->
				<div class="privacy_box_container nicescroll_area_outer" style="height:400px; margin-bottom:0;">
                    ...
                    <form role="form" name="join_form" action="iusersJoinStep6.do">
				<p style="margin-top:20px;">
			      <label>
			        <input id="user_comply" name="user_comply" type="checkbox" value="true" class="filled-in" />
			...
			<div class="row">        			
           		<div class="btn_area double" align="center" style="margin-top:10px;">
					<span>
						...
						<a href="#" id="btnCancel6"	class="waves-effect waves-light btn grey" role="button" style="width:15%;">취소</a>
					</span> 
					<span>
...
function print(printArea)
{
		...
		/*
			...
			6. 인쇄 확인이 되면 팝업창은 자동으로 window.close()를 호출하여 닫힘
		*/
		win.document.write('<html><head><title></title><link href="/ibom/resources/css/styles.css" rel="stylesheet"><link href="/ibom/resources/materialize/css/materialize.css" rel="stylesheet">');
