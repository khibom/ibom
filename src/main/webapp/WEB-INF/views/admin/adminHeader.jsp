                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <li class="a-gray">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="morris.html"><i class="fa fa-list-ol fa-fw"></i>&nbsp;회원등급설정</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/moveDepolist.do"><i class="fa fa-money fa-fw"></i>&nbsp;예치금관리</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="fa fa-cut fa-fw"></i>&nbsp;탈퇴회원관리</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li class="a-gray">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="fa fa-users fa-fw"></i>&nbsp;회원수</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="fa fa-cut fa-fw"></i>&nbsp;탈퇴사유</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <!-- 6.약관 관리-->
                    <li class="a-gray">
                        <a href="index.html"><i class="fa fa-cog fa-fw"></i> 약관관리</a>
                    </li>
