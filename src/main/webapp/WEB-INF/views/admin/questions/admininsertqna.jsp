...
<!--  메인 ================================================================== -->
	...
	<div id="main_container_inner" class="home">
            ...
            <div class="article_body">
                ...
                <form action="${pageContext.request.contextPath}/qnainsert.do" method="post" onsubmit="return qnaubmit();">
                <table class="type05">
			    <tr>
			    ...
			    <tr>
			        <th scope="row">이용서비스 조회</th>
			        <td><select name="user_service">
			        <option selected value="해당사항 없음">--해당사항 없음--</option>
			        </select>
			        <input type="button" style="width:90px ;height:44px;margin-left: 20px;" class="jt_search3_button search" value="서비스 조회">
			        </td>
			        <th scope="row">민원구분</th>
			        <td><select name="civil_petition">
			...
			<input type="button" style="margin-left: 10px;" class="jt_search3_button search" onclick="location.href='${pageContext.request.contextPath}/movequestions.do'" value="목록으로">
