...
<!-- nav 끝  -->      
    ...
    <!--===========================================================================-->
	    ...
	    <tr>
	        ...
	        <td><a href="${pageContext.request.contextPath}/admin/qnaadmindetail.do?anum=${row.qna_no}&page=${commonPage.currentPage}">${row.qna_title}</a></td>
	        <c:choose>
	        <c:when test="${row.qna_state == '미처리' }">
	        <td></td>
	        <td><button type="button" class="btn btn-warning btn-xs" onclick="location.href='${pageContext.request.contextPath}/admin/qnaadmindetail.do?anum=${row.qna_no}&page=${commonPage.currentPage}'">답변하기</button></td>
	        </c:when>
