...
<!-- nav 끝  -->      
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">일반형 활동일지</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
      ...
      <div class="modal-content">
        ...
        <form action="${pageContext.request.contextPath}/admin/actNomalAccept.do" onsubmit="return LogSucCheck();" method="post">
 	...
 	<div id="myModal2" class="modal2">
      ...
      <div class="modal-content2">
       ...
       <h4 style="float:left; width:49%;margin-top:5px;">반려사유</h4>
        <form action="${pageContext.request.contextPath}/admin/returnNomalAct.do" onsubmit="return LogCancelCheck();"method="post">
		<input type="hidden" name="time_no" value="${nomal.time_no}">
        	<table class="table table-hover">
        	<tbody>
        		<tr>
        ...
        <br><br><br>
                        ...
                        <div class="panel-body">
							...
							<textarea rows="5"name="ac_content" style="border:none; width:100%;" readonly>${nomal.ac_content}</textarea>
							</td>
							</tr>
                          </tbody>
                        </table>
                        <c:if test="${ nomal.process_ctgry eq '대기'}">
