...
<!-- nav 끝  -->      
    ...
    <!--===========================================================================-->
	    ...
	    <tr>
	        <td>${row.notice_no}</td>
	        <td><a href="${pageContext.request.contextPath}/admin/adminnoticedetail.do?anum=${row.notice_no}&page=${commonPage.currentPage}">${row.notice_title}</a></td>
	        <td>${row.emp_name}</td>
	        <c:choose>
