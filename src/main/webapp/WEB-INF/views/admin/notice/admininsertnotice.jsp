...
<!-- nav 끝  -->      
    ...
    <div id="page-wrapper">
        ...
        <!-- /.row -->
        <div class="row">
        <form action="${pageContext.request.contextPath}/admin/noticeinsert.do" method="post" enctype="multipart/form-data" onsubmit="return noticesubmit();">
                <div class="col-lg-12">
			    ...
			    <tr>
			        ...
			        <td colspan="4"><input type="text" class="form-control" style="width: 100%;" name="notice_title" id="title"></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			    	...
			    	<td colspan="4"><textarea style="width: 100%" rows="10" cols="10" class="form-control" name="notice_content" id="content"></textarea></td>
			    </tr>
			</table>
               </div>
            </div>
			...
			<input type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/moveadminnotice.do'" value="목록">
			</div>
            </form>
           </div>
            <!-- /.row -->
