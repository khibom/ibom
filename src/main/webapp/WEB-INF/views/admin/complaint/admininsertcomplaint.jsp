...
<!-- nav 끝  -->      
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
        		...
        		<form action="complaintinsert.do" id="writeForm" method="post">
                <table class="table">
			    <tr>
			    ...
			    <tr>
			        ...
			        <td colspan="4"><input type="text" class="form-control" name="com_title"></td>
			    </tr>
			    <tr>
			    	<th scope="row" class="info2">내용</th>
			    	<td colspan="4"><textarea style="width: 100%" rows="10" cols="10" class="form-control" name="com_content"></textarea></td>
			    </tr>
			</table>
			<div style="text-align:right;">
			<input type="submit" class="btn btn-warning" value="등록">
			<input type="button" class="btn btn-default" onclick="location.href='moveadmincomplaint.do'" value="목록">
			</div>
               </form>
               </div>
            </div>
