        ...
        <div class="header_wrap">
            ...
            <nav class="main_menu_container">
                <ul id="menu" class="main_menu">
                    ...
                    <li class="menu_item_has_children ">
                        <a href="/Contents/Series" data-font="secondary"><span>마이페이지</span></a>
                        <ul class="menu_child_group">
                            <li class=""><a href="/Contents/Series"   ><span>이용자정보변경</span></a></li>
                            <li class=""><a href="/Contents/Character"><span>가족정보관리</span></a></li>
                            <li class=""><a href="/Contents/Music"    ><span>질병아동이력</span></a></li>
                            <li class=""><a href="/Contents/Video"    ><span>이용제한이력</span></a></li>
                   ...
                   <li class="menu_item_has_children ">
                        <a href="/Contents/Series" data-font="secondary"><span>서비스신청/조회</span></a>
                        <ul class="menu_child_group">
                    ...
                    <!-- ======================================================================================-->
                   <li class="menu_item_has_children ">
                        <a href="/Communicate/Notice" data-font="secondary"><span>카드결제내역</span></a>
                        <ul class="menu_child_group">
                            <li class=""><a href="${pageContext.request.contextPath}/iusers/moveSumary.do"><span>카드결제내역</span></a></li>
            ...
            <div class="small_menu_container_inner">
                ...
                <nav class="small_screen_menu_container">
                    <ul class="small_screen_menu">
                        ...
                        <li class="menu_item_has_children ">
                            <a href="/Project" data-font="secondary"><span>마이페이지</span></a>
                            <ul class="menu_child_group">
                                <li class=""><a href="/Contents/Series"   ><span>이용자정보변경</span></a></li>
                                <li class=""><a href="/Contents/Character"><span>가족정보관리</span></a></li>
                                <li class=""><a href="/Contents/Music"    ><span>질병아동이력</span></a></li>
...
>>>>>>> branch 'master' of https://github.com/khibom/ibom.git
</html>