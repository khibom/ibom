...
<!--  메인 ================================================================== -->
	...
	<div id="main_container_inner" class="notice_list">
            ...
            <div class="article_body">
                ...
                <form action="qnainsert.do" method="post" onsubmit="return qnasubmit();">
                <table class="type05">
			    <tr>
			    ...
			    <tr>
			        <th scope="row">제목</th>
			        <td colspan="4"><input style="width:100%" type="text" name="qna_title" id="title"></td>
			    </tr>
			    <tr>
			    	<th scope="row" style="height:300px; line-height: 16;">내용</th>
			    	<td colspan="4"><textarea style="width: 100%;"rows="15" cols="10" name="qna_content" id="content"></textarea></td>
			    </tr>
			    <tr>
