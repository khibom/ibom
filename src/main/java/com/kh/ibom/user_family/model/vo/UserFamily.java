...
public class UserFamily implements Serializable{
	...
	public UserFamily(String family_relationship, String family_name, String kor_yesno, String family_no,
			String family_gender, String family_blood, String dolbom_type, String ad_level, String select_type,
			String family_etc) {
		super();
