...
public class DolbomiController {
	...
	//관리지가 돌보미 전체 리스트
			@RequestMapping("admin/dollist.do")
			public ModelAndView dolbomiSelectList(@RequestParam(value="currentPage", required=false, defaultValue="1") int currentPage, CommonPaging page, ModelAndView mv) {
