...
public class AssignmentController {
	...
	public ModelAndView dolAssignSelectList(@RequestParam(value="page", required=false, defaultValue="1") int currentPage, CommonPaging page ,ModelAndView mv) {
		
		String dol_id = page.getIbom_id();
