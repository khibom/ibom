...
public class Questions implements Serializable{
	...
	public Questions(String qna_no, String personal_info, String civil_petition, String qna_title,
			Date qna_date, String qna_state, String qna_content, String qna_answer, String user_name, String dol_name,
			String emp_name, String term_code) {
		super();
		this.qna_no = qna_no;
	...
	public String toString() {
		return "Questions [qna_no=" + qna_no + ", personal_info=" + personal_info 
